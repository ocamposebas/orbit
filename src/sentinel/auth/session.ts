...
const sessionInclude = { user: { select: { id: true, email: true, name: true, active: true, memberships: { select: { organizationId: true, role: true } } } }, organization: { select: { id: true, name: true, isDemo: true } } } as const;
