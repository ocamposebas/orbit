...
export function mergeProgress(current: Partial<ScanProgress>, patch: Partial<ScanProgress>, updatedAt = new Date().toISOString()): ScanProgress {
  ...
  const progress: ScanProgress = {
    ...
    visualCoveragePercent: patch.visualCoveragePercent ?? current.visualCoveragePercent ?? 0,
    ...
    documentCoveragePercent: patch.documentCoveragePercent ?? current.documentCoveragePercent ?? 0,
    ...
    semanticCoveragePercent: patch.semanticCoveragePercent ?? current.semanticCoveragePercent ?? 0,
    ...
    scanCoveragePercent: patch.scanCoveragePercent ?? current.scanCoveragePercent ?? 0,
