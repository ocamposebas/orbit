...
const principles = [
  ...
  { title: "Clarity over claims", text: "ORBIT is focused B2B software for monitoring and review support. It does not provide legal advice or guarantee compliance outcomes.", icon: ShieldCheck },
];

export default function AboutPage() {
  return <>
    <PageHero eyebrow="Company" title="Make merchant risk easier to see." description="ORBIT is building the continuous intelligence layer between point-in-time merchant reviews and the websites, policies, products, and compliance signals that keep changing." />
    <section className="py-24 sm:py-32"><div className="container-shell grid gap-14 lg:grid-cols-2"><div><p className="eyebrow">Our point of view</p><h2 className="mt-5 text-balance text-4xl font-medium leading-[1] tracking-[-.05em] sm:text-6xl">Compliance work deserves better context.</h2></div><div className="space-y-5 text-base leading-8 text-[#8c8f98]"><p>Merchant review is often fragmented across crawls, screenshots, spreadsheets, tickets, and institutional memory. The evidence changes while the record stays still.</p><p>ORBIT brings monitoring, findings, remediation, and historical context into one workspace so teams can see what changed and document what happened next.</p><p>We focus on software and intelligence. Legal interpretation and final review decisions remain with the responsible teams.</p></div></div></section>
