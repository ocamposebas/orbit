...
export default function RefundPage() {
  return <LegalShell title="Refund & Cancellation Policy" summary="This policy explains cancellation, renewal, and refund handling for ORBIT B2B software subscriptions.">
    ...
    <h2>6. Implementation and custom work</h2><p>Implementation, onboarding, custom configuration, and professional-service fees are generally non-refundable after the work begins because they cover reserved capacity and completed work. Any different milestone or cancellation treatment will be stated in the applicable order form.</p>
    <h2>7. How to request cancellation or billing review</h2><p>Send the workspace name, company name, account contact, and reason for the request to the configured support email. Do not include passwords, payment-card numbers, or unnecessary sensitive information. ORBIT will confirm receipt and explain the effective cancellation date or information needed to review a billing issue.</p>
  </LegalShell>;
}
