...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ next?: string | string[] }> }) {
  ...
  return <section className="page-orbit-hero relative grid min-h-[calc(100vh-1px)] place-items-center overflow-hidden px-4 pb-20 pt-28"><div className="relative z-10 w-full max-w-[410px] rounded-[6px] border border-white/[.1] bg-[#080a18]/90 p-6 shadow-[0_30px_100px_rgba(0,0,0,.55)] backdrop-blur-xl sm:p-9"><Logo/><h1 className="mt-12 text-3xl font-medium">Welcome back.</h1><p className="mt-2 text-sm text-[#999bb3]">Sign in to your ORBIT workspace.</p><div className="mt-8"><LoginForm nextPath={nextPath}/></div></div></section>;
}
