...
import { ArrowLeftRight, ChevronDown, CircleHelp, CreditCard, LayoutDashboard, Layers3, LogOut, Menu, RefreshCw, ScanSearch, Settings, WalletCards, X } from "lucide-react";
import { useState, useTransition } from "react";
import { cn } from "@/lib/utils";

export function PortalShell({ children, merchantName, merchantId, merchants, userName, adminPortfolio }: { children: React.ReactNode; merchantName: string; merchantId: string; merchants: Array<{ id: string; businessName: string }>; userName: string; adminPortfolio: boolean }) {
