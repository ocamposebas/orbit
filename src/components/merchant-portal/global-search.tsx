...
export function GlobalSearch() {
  ...
  return <>
    <button type="button" onClick={() => setOpen(true)} className="inline-flex h-9 items-center gap-2 rounded-[10px] border border-white/[.08] bg-white/[.025] px-3 text-[11px] text-[#9297a1] transition hover:border-[#7868e8]/30 hover:text-white" aria-label="Open global search"><Search className="size-3.5" /><span className="hidden sm:inline">Search</span><kbd className="hidden rounded border border-white/[.08] px-1.5 py-0.5 text-[8px] text-[#626874] md:inline">Ctrl K</kbd></button>
