  ...
  return (
    <div className="panel overflow-hidden rounded-[6px]">
      <div className="flex items-center justify-between border-b border-white/[.08] px-4 py-3 sm:px-5">
        <div className="flex items-center gap-2"><ScanSearch className="size-4 text-[#a78bfa]"/><span className="text-xs font-medium">Website scanner</span></div>
      ...
      <div className="grid lg:grid-cols-[1.35fr_.85fr]">
        <div className="relative min-h-[370px] overflow-hidden border-b border-white/[.08] bg-[#0a0c0f] p-4 sm:p-6 lg:border-b-0 lg:border-r">
          ...
          <div className="relative mt-5 overflow-hidden rounded-lg border border-white/[.07] bg-[#0e1014]">
            ...
            <motion.div animate={{ top: ["12%", "90%", "12%"] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="absolute inset-x-0 top-0 h-px bg-[#7c5cff] shadow-[0_0_16px_2px_rgba(124,92,255,.62)]" />
          </div>
          <div className="mt-4 flex items-center gap-2 text-[10px] text-[#80838c]"><motion.span animate={{ rotate: 360 }} transition={{ duration: 3, repeat: Infinity, ease: "linear" }} className="block size-3 rounded-full border border-[#7c5cff]/35 border-t-[#a78bfa]"/>Scanning merchant website...</div>
        </div>
