...
export const aiScannerToolDefinitions = [
  ...
  tool("inspect_product", "Open a Luna-selected likely product and retain objective URL, price, SKU, variant, add-to-cart, structured-data, DOM, and visual evidence.", { url }),
  ...
  tool("inspect_checkout_read_only", "Open a Luna-selected first-party public cart/checkout URL in a fresh read-only state; never submit, pay, or accept terms.", { url }),
] as const;
